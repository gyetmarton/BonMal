...
def Setup_Joint_Model(Parameters, Types, J, epsilon):
    ...
    #g-definition
    backend.stationer_U.Constraint.Add_AbsoluteVariableDefinition(model, Types, K, Exp_claims, L, pi, c, o, g)
    
    #o-definition
    backend.stationer_U.Constraint.Add_PremiumChangeDefinition(model,Types, K, L, epsilon, psi, o, c, O)
    
    #premium_rules
    backend.stationer_U.Constraint.Add_PremiumConstraints(model, K, pi, epsilon, L, O)
...
def Setup_TR_Model(Parameters, Types, J):
    ...
    backend.stationer_U.Constraint.Add_AbsoluteVariableDefinition_NoChange(model, Types, K, Exp_claims, pi, c, g)
