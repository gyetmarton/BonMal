...
import pulp as pulp
import backend_PulP_st_TR as backend


def Setup_Joint_Model(nbr_of_classes, max_nbr_of_claims,Exp_claims, Ratio_of_types,Types, Prob_of_claims, J, epsilon, Obs_claims):
