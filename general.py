...
def run_simple(Parameters):
    ...
    #Calculate results
    if OP_calculation:
        Results["OP"] = Optimisation.OP#calculation.solution.OP_group(Optimisation.Stat_probabilities, Results["Premiums"], Optimisation.Types, Parameters["Exp_claims"], Parameters["Ratio_of_types"], Parameters)
        Results["TOP"] = Optimisation.TOP#calculation.solution.total_OP(Optimisation.Stat_probabilities, Results["Premiums"], Optimisation.Types, Parameters["Exp_claims"], Parameters["Ratio_of_types"], Parameters)
    else:
        Results["OP"] = 0
        Results["TOP"] = 0
    ...
    return  Results#running_time, objective, Transition_rules, Premiums, OP, TOP